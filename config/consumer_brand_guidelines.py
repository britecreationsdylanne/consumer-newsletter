...
AI_PROMPTS = {
    "generate_intro": (
        "Write a short, witty pun or quip for the {month} issue of BriteCo's consumer "
        "jewelry newsletter. This is the opening line readers see first.\n\n"
        "Requirements:\n"
        "- 1-2 sentences MAX, keep it punchy\n"
        "- Max 20 words — shorter is better\n"
        "- Must be a clever pun, wordplay, or witty one-liner\n"
        "- Tie to the season, month, or jewelry in a playful way\n"
        "- Conversational and warm — like a fun friend\n"
        "- Do NOT include any label, prefix, or heading — return ONLY the intro text\n"
        "- Do NOT wrap in quotes\n\n"
        "Content highlights this month: {highlights}\n\n"
        "Examples of the vibe:\n"
        "- 'New year, same sparkle. (Okay, maybe a little more.)'\n"
        "- 'February called — it wants you to treat yourself.'\n"
        "- 'Spring cleaning? Great. Spring shopping? Even better.'\n"
        "- 'A wedding budget is like a diamond: starts under pressure and keeps getting cut.'"
    ),
    "generate_whats_inside": (
        "Generate 4 'What's Inside' items for a consumer jewelry newsletter. "
        "Each item should:\n"
        "- Start with a single relevant emoji, then a space, then the text\n"
        "- Tease the section content without giving everything away\n"
        "- Be one short, catchy line\n"
        "- Build curiosity\n\n"
        "Output rules:\n"
        "- Return ONLY the 4 items, one per line\n"
        "- Do NOT include any preamble, intro, or closing line (never write things like 'Here are 4 items')\n"
        "- Do NOT number the items or add a bullet/dash character; the leading emoji is the only marker\n\n"
        "Sections to tease:\n{sections}\n\n"
        "Examples from past issues:\n"
        "💎 Met Gala 2025: The jewels that stole the red carpet\n"
        "🌀 Hurricane season is coming — is your wedding venue ready?\n"
        "💰 Suspects Charged in Louvre Heist\n"
        "🎃 Pumpkin Spice Jewelry\n"
        "💍 Should T. Swift Insure Her Ring?\n"
        "✨ 80% of Americans Buy Fine Jewelry"
